    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0A0C10] p-6 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-semibold text-white tracking-tight text-center leading-tight">Buat Akun Baru</h1>
          <p className="text-slate-500 font-bold  text-xs tracking-wide mt-2">Kecerdasan Keuangan Pribadi</p>
        </div>
        ...
        <p className="mt-12 text-center text-slate-500 font-bold text-xs  tracking-wide">
          Sudah punya akun?{' '}
