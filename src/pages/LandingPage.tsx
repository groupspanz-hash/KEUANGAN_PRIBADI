    ...
    <div className="min-h-screen bg-[#0A0C10] text-slate-200 overflow-x-hidden selection:bg-emerald-500/30">
      ...
      <nav className="relative z-50 max-w-7xl mx-auto px-8 py-10 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="text-xl font-semibold text-white tracking-tighter leading-none">SF MONITOR</span>
            <span className="text-xs font-semibold text-emerald-500  tracking-wide mt-1">Intelligence</span>
          </div>
        </div>
        <div className="hidden md:flex items-center gap-10">
          <a href="#features" className="text-xs font-semibold text-slate-500 hover:text-white  tracking-wide transition-colors">Fitur</a>
          <a href="#security" className="text-xs font-semibold text-slate-500 hover:text-white  tracking-wide transition-colors">Keamanan</a>
        </div>
        <div className="flex items-center gap-6">
          <Link to="/login" className="text-xs font-semibold text-slate-500 hover:text-white  tracking-wide transition-colors">Masuk</Link>
          <Link 
            to="/register" 
            className="px-8 py-3.5 bg-emerald-500 text-white text-xs font-semibold  tracking-wide rounded-full hover:scale-105 active:scale-95 transition-all flex items-center gap-3 shadow-[0_0_20px_rgba(16,185,129,0.3)]"
          >
            Dapatkan Akses
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-8 pt-24 pb-32 flex flex-col items-center text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-900/50 border border-slate-800 text-emerald-400 text-xs font-semibold  tracking-wide mb-12 backdrop-blur-xl"
        >
        ...
        <motion.h1
          ...
          className="text-7xl md:text-[140px] font-semibold tracking-tighter leading-[0.8] mb-10 text-white"
        >
          KEUANGAN <br />
        ...
        >
          <Link 
            to="/register" 
            className="px-12 py-6 bg-white text-black text-xs font-semibold  tracking-wide rounded-2xl hover:scale-105 active:scale-95 active:scale-95 transition-all flex items-center gap-4 shadow-2xl"
          >
            Mulai Sekarang
          ...
          <Link 
            to="/login" 
            className="px-12 py-6 bg-slate-900/50 text-white border border-slate-800 text-xs font-semibold  tracking-wide rounded-2xl hover:bg-slate-800 transition-all backdrop-blur-xl"
          >
            Lanjutkan Sesi
          </Link>
        </motion.div>
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div
            ...
            className="md:col-span-2 p-12 rounded-[40px] bg-gradient-to-b from-white/[0.05] to-transparent border border-white/[0.05] backdrop-blur-md shadow-2xl hover:shadow-emerald-500/5 transition-all duration-300 relative overflow-hidden group"
          >
            <div className="relative z-10">
              ...
              <h3 className="text-4xl font-semibold text-white mb-4 tracking-tight">Inti Semantik AI</h3>
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            className="p-12 rounded-[40px] bg-gradient-to-b from-white/[0.05] to-transparent border border-white/[0.05] backdrop-blur-md shadow-2xl hover:shadow-emerald-500/5 transition-all duration-300 group"
          >
            ...
            <h3 className="text-3xl font-semibold text-white mb-4 tracking-tight">Sinkronisasi Cloud</h3>
          ...
          >
            ...
            <h3 className="text-3xl font-semibold text-white mb-4 tracking-tight">Enkripsi</h3>
          ...
          >
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
              <div className="flex-1">
                ...
                <h3 className="text-4xl font-semibold text-white mb-4 tracking-tight">Analisis Visual</h3>
      ...
      <footer className="relative z-10 border-t border-slate-900 py-16 mt-20 bg-[#0A0C10]">
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm font-semibold text-white  tracking-wide">SF MONITOR SISTEM</span>
          </div>
          <p className="text-slate-500 text-xs font-semibold  tracking-wide">© 2026 SmartFinance Collective. Professional Intelligence Deployment.</p>
          <div className="flex items-center gap-10">
            <a href="#" className="text-xs font-semibold text-slate-500 hover:text-white  tracking-wide transition-colors">Privasi</a>
            <a href="#" className="text-xs font-semibold text-slate-500 hover:text-white  tracking-wide transition-colors">Ketentuan</a>
